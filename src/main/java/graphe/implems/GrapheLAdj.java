...
public class GrapheLAdj implements IGraphe {
    ...
    public boolean contientSommet(String sommet) {
        // Utilisation de la méthode KeySet.contains de la classe HashMap pour vérifier si le sommet est présent dans la liste d'adjacence
